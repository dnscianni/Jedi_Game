...
public class Jedi extends Person {
	...
	/**
	 * This is the default serial ID of the Jedi class
	 */
	private static final long serialVersionUID = 1L;
	
	/**
	 * The value that determines whether the jedi is chasing Player
	 */
	 ...
	 */
	public Jedi(int x, int y, boolean c) {
		super(x, y);
	 ...
	 *         stabbed.
	 */
	public boolean stab(Player p, Map m, boolean b, boolean GUI) {
	...
	/**
	 * Changes whetere the Jedi is chasing or not
	 * @param c a boolean value that will be used to change chasing
	 */
