...
public abstract class Person {
	...
	/**
	 * The person constructor will put the integer x into {@code location[0]}
	 * and the integer y into {@code location[1]}.
	 */
	...
	/**
	 * The move method will determine how the person moves in the game.
	 */
	public abstract void move(int d);

	/**
	 * (@link die) is a method that determines what happens if a person dies.
	 */
	public abstract void die();

	/**
	 * (@link getLocation) is a method that returns the location of a player.
	 */
