...
public abstract class Item {
	...
	/**
	 * This method will be the generic method used by each Item object. Within
	 * the subclasses corresponding to each different object, the specific
	 * behaviors of this method will change based on the Item.
	 */
	public abstract void activate();

	/**
	 * This will return the location array, so that we can know the location of
	 * the item.
	 */
