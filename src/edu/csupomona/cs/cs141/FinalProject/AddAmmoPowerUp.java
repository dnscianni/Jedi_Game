 ...
 * in the game that adds a single bullet to the player's Gun. It extends
 * the class {@link Item}, and thus it inherits Item's {@code location} field
 * (an array of 2 integers, holding values for the item's x-coordinate and
...
public class AddAmmoPowerUp extends Item {
	 ...
	 * random location for the AddAmmoPowerUp to be set to.
	 */
	public AddAmmoPowerUp() {
	}
