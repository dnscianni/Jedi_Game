...
/**
 * (@link main) is used to test our class Holocron
 * 
 * @author Team Jedi
 * 
 */
public class HolocronTest {

	/**
	 * (@link main) contains commands to test if our class Holocron runs
	 * properly.
	 * 
	 * @param args
	 */
	public static void main(String[] args) {
		Holocron h = new Holocron(5, 5); // creates class holocron of object
											// Holocron at location (5,5)
		try {
			h.activate(); // ends game when player wins
		} catch (GameOverException e) { // ends game when player wins or loses
										// all their lives
