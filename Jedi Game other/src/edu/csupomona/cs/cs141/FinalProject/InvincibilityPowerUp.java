...
public class InvincibilityPowerUp extends Item { // take away activate from item
	...
	/**
	 * The default serial ID of the InvincibilityPowerUp class.
	 */
	...
	/**
	 * This constructor will call the {@link Item} constructor and will set up
	 * the location for the InvincibilityPowerUp to be set to x and y.
	 * 
	 * @param x
	 ...
	 * It will also set the location to -1, -1 so that it will be out of the
	 * playable area.
	 * 
	 * @param p
	 *            The player that will be passed to the activate method.
	 */
