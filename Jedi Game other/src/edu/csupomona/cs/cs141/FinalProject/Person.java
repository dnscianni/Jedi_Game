...
public abstract class Person implements Serializable {
	...
	/**
	 * The default serial ID for the Person class.
	 */
	...
	/**
	 * The place holder for the die method of it's subclasses. This one throws
	 * the GameOverException so that the game will end if the player dies.
	 * 
	...
	/**
	 * The place holder for the die method of it's subclasses. This one throws
	 * the GameOverException so that the game will end if the player dies. It
	 * also takes in a map and boolean b.
	 * 
	 * @param m
	 *            The map that the die method will need to call the locations in
	 *            the map.
	 * @param b
	 *            The boolean representing whether or not the game is in debug
	 *            mode.
	 * @throws GameOverException
	 */
	 ...
	 * 
	 * @return The array location, that has the person's location in the map.
	 */
