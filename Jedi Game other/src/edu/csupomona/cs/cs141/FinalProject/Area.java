...
public class Area {
	...
	/**
	 * This field will check to see if the are is a room or not. If so, then A
	 * jedi and power ups wont be allowed inside. also a holocron can only be
	 * placed in an area if it is a room.
	 */
	private boolean isRoom;

	/**
	 * This default constructor creates an empty area. It also sets is room to
	 * the boolean b that is passed.
	 * 
	 * @param b
	 *            either true if its a room, or false if it is not.
	 */
	...
	/**
	 * This is to check if the area is a room or not.
	 * 
	 * @return true if it is a room and false if it is not.
	 */
