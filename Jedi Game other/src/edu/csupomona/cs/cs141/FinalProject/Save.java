...
public class Save implements Serializable {
	/**
	 * The default serial ID of the Save class.
	 */
	...
	/**
	 * This will be an array of size 4, which will hold the
	 * {@link InvincibilityPowerUp}, the {@link AddAmmoPowerUp}, the
	 * {@link RadarPowerUp}, and the {@link Holocron}.
	 */
	Item[] theItems;

	/**
	 * This saves the boolean that decides if the game is set in debug mode or
	 * regular mode.
	 */
	boolean debug;
	...
	/**
	 * This method will set all elements of the array {@code theItems} to be the
	 * same as each element of the array i whenever the game is saved.
	 * 
	 * @param i
	 *            the state of each {@link Item} when the game is saved.
	 */
	...
	/**
	 * This method will set the field debug to the boolean d that is sent
	 * 
	 * @param d
	 *            Either true for a debug game or false for a standard game.
	 */
	...
	/**
	 * This method will return the array {@code theItems} whenever the game is
	 * loaded. Each of this array's elements will represent the state of each of
	 * the game's {@link Item} when the game was previously saved.
	 * 
	 * @return an array where each element holds the status of one of the 4
	 *         {@code Item}s, which was loaded from a file
	 */
	...
	/**
	 * Will send the boolean debug, that determines which mode the game is in.
	 * 
	 * @return True if in debug mode or false if not.
	 */
