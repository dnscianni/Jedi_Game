...
public class Player extends Person {
	/**
	 * This is the default serial ID of the Player class
	 */
		...
		case 1:
			if (this.location[1] - 1 >= 0
				...
				if (this.location[1] - 2 >= 0
					...
					if (this.location[1] - 3 >= 0
							&& !m.getArea(this.location[0],
									this.location[1] - 3).getIsRoom()) {
		...
		case 2:
			if (this.location[0] + 1 <= 8
				...
				if (this.location[0] + 2 <= 8
					...
					if (this.location[0] + 3 <= 8
							&& !m.getArea(this.location[0] + 3,
									this.location[1]).getIsRoom()) {
						m.setMaze(this.getLocation()[1] * 2 + 1,
								this.getLocation()[0] * 4 + 14, " ");
		...
		case 3:
			if (this.location[1] + 1 <= 8
				...
				if (this.location[1] + 2 <= 8
					...
					if (this.location[1] + 3 <= 8
							&& !m.getArea(this.location[0],
									this.location[1] + 3).getIsRoom()) {
						m.setMaze(this.getLocation()[1] * 2 + 7,
								this.getLocation()[0] * 4 + 2, " ");
	...
	/**
	 * Returns the invincibilityCounter, so that we can use it in the main code.
	 * 
	 * @param noChange
	 *            It will always pass true, to differentiate it from the other
	 *            method.
	 * @return invincibilityCounter
	 */
	...
	/**
	 * Returns the Gun object in Player
	 * 
	 * @return blaster
	 */
	public Gun getGun() {
