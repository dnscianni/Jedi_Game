...
public class Save implements Serializable {
	/**
	 * This is the default serial ID of the Save class
	 */
	...
	/**
	 * This value will be used to save wheter the game was running in debug or
	 * not
	 */
	boolean debug;
	...
	/**
	 * Sets the debug, if you want to change it.
	 * 
	 * @param d
	 *            the boolean that sets debug.
	 */
	...
	/**
	 * This method returns the value of the boolean debug
	 * 
	 * @return debug
	 */
