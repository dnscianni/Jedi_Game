...
public class Map {
	...
	/**
	 * This constructor will initalize and instantiate map with Areas and puts
	 * together maze
	 */
	public Map(boolean b) {
		...
		String[] lineOne = { "=", "=", "=", "=",
				...
				"=",
				"=",
				"=", // Strings arrays lineOne, lineTwo, lineThree, lineFour
						// are
	...
	/**
	 * Sets a string value to an index in maze
	 * 
	 * @param x
	 *            the first index
	 * @param y
	 *            the second index
	 * @param s
	 *            the string to be placed in maze
	 */
